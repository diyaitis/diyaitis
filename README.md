...
- **[Purplle Store Intelligence](https://github.com/diyaitis/purplle-store-intelligence)** — full-stack store intelligence system (FastAPI, React, YOLOv8, Redis, Postgres, Docker) built for the Purplle Tech Challenge.
